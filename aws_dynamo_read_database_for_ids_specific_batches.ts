...
import { PaymentPaidRecord } from './payment-paid-record';
...
const listOfFiles: string[] = ['payment-paid-file-creation#2022-06-22T02:00:44.584Z',
                               'payment-request-file-creation#2022-06-22T02:00:24.421Z',
                               'payment-issued-file-creation#2022-06-22T02:00:23.347Z',
                               'payment-reversal-file-creation#2022-06-30T02:00:42.120Z'];
...
const getPaymentsTable = async (idInput) => {
    ...
    const params: DocumentClient.QueryInput = {
        ...
        KeyConditionExpression: `id = :id_e`,
        ExpressionAttributeValues: {
            ':id_e': idInput
        }
    };
    ...
    if (resultQ) {
        ...
        const paymentpaid: PaymentPaidRecord[] = (resultQ.Items as PaymentPaidRecord[]) || [];
        // console.log(`items found ${paymentpaid[0]}`);
        return paymentpaid[0].tdu_correlation_id;
    } else {
        console.log('No - items found');
        return `${idInput}`;
    }

...
function logVistor(param) {
    if (typeof param === 'number') {
        console.log("".concat(param, " new visitors arrived"));
    }
    else {
        //string
        console.log("".concat(param.toUpperCase(), " visited"));
    }
}
console.log("  number ".concat(logVistor(500)));
console.log("  named  ".concat(logVistor('Jeff')));

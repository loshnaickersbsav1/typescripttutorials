...
import { UnversityLibrarian, Employee, Researcher, PublicLibrarian } from "./a_classes"
...
// if (lib instanceof UnversityLibrarian) {
//     lib.assistCustomer('Jeff'); // compiler narrows types to Ubiversity class ; when using the instance of
// }
// if (lib instanceof PublicLibrarian) {
//     lib.teachCommunity();
// }

// interfaces, not primitive types, no constructors. e.g. Book

// function isBook (text : Books | Magazine): text is Books { // predicate returned
//     return (<Books>text).author !== undefined;
// }

// let readingMaterial2: Books | Magazine = ;

// if (isBook(readingMaterial2) ) {
//     console.log(`The books author is ${readingMaterial2.author}`);
// }
// else
// {
//     console.log(`The magazine pub is ${readingMaterial2.publisher}`);
// }
...
console.log(mySymbol === anotherSymbol); // not equal
console.log(typeof mySymbol);

// make good property key 1
let myObject = { [mySymbol] : 'value of symbol'}; //surround square brackets

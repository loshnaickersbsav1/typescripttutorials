...
try {
    ...
    documentClient = new dynamodb.DynamoDBClient({ region: 'us-east-1' });
...
const addAllDataElements =  (stagingRecords: JobStagingRecord) => {
    ...
    const params:  aws.DynamoDB.DocumentClient.PutItemInput = {
        ...
        Item: {
            ...
            'batch_name': stagingRecords.batch_name,
            'batch_start_time': stagingRecords.batch_start_time,
            'ttl': 1856143065219,
            'reference_id': stagingRecords.reference_id
        }
    };
